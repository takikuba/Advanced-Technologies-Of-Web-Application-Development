...
public class Recipe {
    ...
    public Recipe(String name, String description, int likeB, int dislikeB, int kcal, int time, String image, String link, long idAssignedBy) {
        this.name = name;
    ...
    public Recipe(String name, String description, int kcal, int time, String image, String link, long idAssignedBy) {
        this.name = name;
        this.description = description;
        this.kcal = kcal;
        this.time = time;
